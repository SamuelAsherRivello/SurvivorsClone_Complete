...
var spr_jav_reg = preload("res://Art/Textures/Items/Weapons/javelin_3_new.png")
var spr_jav_atk = preload("res://Art/Textures/Items/Weapons/javelin_3_new_attack.png")
