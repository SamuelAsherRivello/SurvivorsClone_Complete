...
#Attacks
var iceSpear = preload("res://_Prefabs/Player/Attacks/icespear.tscn")
var tornado = preload("res://_Prefabs/Player/Attacks/tornado.tscn")
var javelin = preload("res://_Prefabs/Player/Attacks/javelin.tscn")
